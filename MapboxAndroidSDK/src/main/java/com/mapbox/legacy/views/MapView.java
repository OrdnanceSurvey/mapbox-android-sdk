...
import com.mapbox.legacy.R;
import com.mapbox.legacy.api.ILatLng;
import com.mapbox.legacy.constants.MapboxConstants;
import com.mapbox.legacy.events.MapListener;
import com.mapbox.legacy.events.ScrollEvent;
import com.mapbox.legacy.events.ZoomEvent;
import com.mapbox.legacy.geometry.BoundingBox;
import com.mapbox.legacy.geometry.LatLng;
import com.mapbox.legacy.overlay.ClusterMarker;
import com.mapbox.legacy.overlay.GeoJSONPainter;
import com.mapbox.legacy.overlay.GpsLocationProvider;
import com.mapbox.legacy.overlay.ItemizedIconOverlay;
import com.mapbox.legacy.overlay.ItemizedOverlay;
import com.mapbox.legacy.overlay.MapEventsOverlay;
import com.mapbox.legacy.overlay.MapEventsReceiver;
import com.mapbox.legacy.overlay.Marker;
import com.mapbox.legacy.overlay.Overlay;
import com.mapbox.legacy.overlay.OverlayManager;
import com.mapbox.legacy.overlay.TilesOverlay;
import com.mapbox.legacy.overlay.UserLocationOverlay;
import com.mapbox.legacy.tileprovider.MapTileLayerBase;
import com.mapbox.legacy.tileprovider.MapTileLayerBasic;
import com.mapbox.legacy.tileprovider.constants.TileLayerConstants;
import com.mapbox.legacy.tileprovider.tilesource.ITileLayer;
import com.mapbox.legacy.tileprovider.tilesource.MapboxTileLayer;
import com.mapbox.legacy.tileprovider.util.SimpleInvalidationHandler;
import com.mapbox.legacy.util.DataLoadingUtils;
import com.mapbox.legacy.util.GeometryMath;
import com.mapbox.legacy.util.MapboxUtils;
import com.mapbox.legacy.util.NetworkUtils;
import com.mapbox.legacy.util.constants.UtilConstants;
import com.mapbox.legacy.views.util.OnMapOrientationChangeListener;
import com.mapbox.legacy.views.util.Projection;
import com.mapbox.legacy.views.util.TileLoadedListener;
import com.mapbox.legacy.views.util.TilesLoadedListener;
import com.mapbox.legacy.views.util.constants.MapViewConstants;
import com.mapbox.legacy.views.util.constants.MapViewLayouts;
...
//        }
     ...
     * com.mapbox.legacy.geometry.LatLng} (0, 0) align
...
//                Log.i(TAG, "mScaleGestureDector not in progress, forward on to mGestureDetector.onTouchEvent()");
     ...
     *
     * @see {@link com.mapbox.legacy.views.safecanvas.ISafeCanvas}
     */
