package com.mapbox.legacy.tileprovider.tilesource;
...
import com.mapbox.legacy.tileprovider.modules.MapTileDownloader;
...
public class TileLayer implements ITileLayer, TileLayerConstants, MapViewConstants {
    ...
    /**
     * Sets the layer's maximum zoom level.
     */
    ...
    public TileLayer setMaximumApiZoomLevel(final float aMaximumZoomLevel) {
        this.mMaximumApiZoomLevel = aMaximumZoomLevel;
        return this;
    }
